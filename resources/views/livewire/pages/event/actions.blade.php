            ...
            <div class="py-4 space-y-2">
                <label class="form-control">
                    ...
                    <input type="text" @class([
                        ...
                        placeholder="Nama lengkap event" />
                </label>
                <label class="form-control">
                    <div class="label">
                        <span class="label-text">Lokasi acara</span>
                    </div>
                    <input type="text" @class([
                        'input input-bordered',
                        'input-error' => $errors->first('form.location_name'),
                ...
                <label class="form-control">
                    ...
                    <input type="text" @class([
                        'input input-bordered',
                        'input-error' => $errors->first('form.latitude'),
                ...
                <label class="form-control">
                    ...
                    <input type="text" @class([
                        'input input-bordered',
                        'input-error' => $errors->first('form.longitude'),
                    ]) wire:model="form.longitude"
                        placeholder="Nama lengkap event" />
                </label>
                <label class="form-control">
                    <div class="label">
                        <span class="label-text">Jam dan tanggal acara</span>
                    </div>
                    <input type="datetime-local" @class([
                        'input input-bordered',
                        'input-error' => $errors->first('form.datetime'),
